    ...
    <script>
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (!hasError) {
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("login")); ?>'; // Redirect to the login route in Laravel
...
<?php /**PATH C:\Users\asus\Barangay_Registry\resources\views/livewire/auth/auth-register.blade.php ENDPATH**/ ?>